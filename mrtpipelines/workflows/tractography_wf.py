...
def genACTTract_wf(nfibers=25000, wdir=None, nthreads=1,
                   name='genACTTract_wf'):
    """
    ...
    siftTract.inputs.out_file = 'variant-ACTtcksift_streamlines-%d_track.tck' % nfibers
    ...
    tractConvert.inputs.out_file = 'variant-ACTtcksift_streamlines-%d_tract.vtk' % nfibers
...
def genDhollTract_wf(nfibers=25000, wdir=None, nthreads=1,
    ...
    genTract = pe.Node(mrt.Tractography(), name='genTract')
    genTract.base_dir = wdir
    genTract.inputs.backtrack = True
